...
public class StatusBarUtil {
    ...
    public static float DEFAULT_ALPHA = 1;//Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? 0.2f : 0.3f;
    ...
    public static void immersive(Window window, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            systemUiVisibility |= View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_LAYOUT_FLAGS;
     ...
     * 设置当前页面全屏显示
     */
    public static void setFllScreen(Context mContext) {
        //设置全屏模式
