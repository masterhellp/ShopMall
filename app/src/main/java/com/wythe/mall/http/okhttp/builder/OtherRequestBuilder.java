...
import com.wythe.mall.http.okhttp.request.OtherRequest;
...
public class OtherRequestBuilder extends OkHttpRequestBuilder
{
    ...
    public RequestCall build()
    {
        ...
        OtherRequest otherRequest = new OtherRequest(requestBody, method,url, tag, params, headers);
        otherRequest.appendParams();
