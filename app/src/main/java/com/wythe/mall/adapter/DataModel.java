...
public class DataModel {
	...
	// 数组的大小为(28)
	public static String[] toolist = new String[] { "蔬菜", "干果", "生鲜",
			"水果", "粮油", "糕点", "美食", "建筑建材" };

	// 数组的大小为(28)
	public static int[] iconList = new int[] {R.mipmap.shucai,R.mipmap.ganguo,
			R.mipmap.shuiguo,R.mipmap.shuiguo,R.mipmap.liangyou,R.mipmap.gaodian,
			R.mipmap.meishi,R.mipmap.jiancai,
