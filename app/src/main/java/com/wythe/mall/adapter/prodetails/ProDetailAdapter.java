...
public class ProDetailAdapter extends RecyclerView.Adapter<ProDetailAdapter.ViewHolder> {
    ...
    public ProDetailAdapter(Context context) {
...
//        CommonUtils.loadIntoUseWidth(context,dataList.get(position),R.mipmap.a,holder.nameView);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            nameView =  itemView.findViewById(R.id.imgView);
        }
    }
