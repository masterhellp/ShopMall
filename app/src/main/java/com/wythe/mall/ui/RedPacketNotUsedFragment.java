 ...
 */
public class RedPacketNotUsedFragment extends Fragment implements OnClickListener{
    ...
    private void initView(){
        ...
        lvRedPacket.setAdapter(new CommonAdapter<RedPacketItem>(getActivity(), R.layout.hongbao_not_used_item, items) {
            @Override
