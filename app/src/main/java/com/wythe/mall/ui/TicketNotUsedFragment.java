 ...
 */
public class TicketNotUsedFragment extends Fragment implements OnClickListener{
    ...
    private void initView(){
        ...
        lvTicket.setAdapter(new CommonAdapter<TicketItem>(getActivity(), R.layout.ticket_not_used_item, items) {
            @Override
